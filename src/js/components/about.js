...
const AboutPageContent = (<div className="about_page">
        ...
        <h2>Как написать свои генераторы для этого проекта?</h2>
        <p>На данный момент код серверной части довольно беспорядочен, поэтому шаги для написания собственного генератора заданий таковы:</p>
        <ul>
